      ...
      ******************************************************************
       ...
       01 VARIABLES.
           05 WSV-PROMEDIO             PIC 9(10)V9(02).
       ...
       01 ACUMULADOR.
           ...
           05 WSC-ACUMMONTO            PIC 9(10)V9(02).
       ...
       01 MASCARAS.
           05 WSM-MASC-MONTOS.
               10 WSM-MASCARAPROMEDIO PIC Z(10),99.
       ...
       200000-INGRESO.
           ...
           PERFORM VARYING WSI-I FROM 1 BY 1 UNTIL WSS-FS-ENTRADA-EOF
               ...
               IF WSS-FS-ENTRADA-OK
                   ...
                   COMPUTE WSC-ACUMMONTO = WSC-ACUMMONTO +
                                           WSC-AUXMONTO(WSI-I)
           ...
           COMPUTE WSV-PROMEDIO = WSC-ACUMMONTO / WSC-CANTREG.
       ...
       300000-IMPRIMIR.
           ...
           '                 |  ' WSC-AUXAÑO(WSI-I)'/'WSC-AUXMES(WSI-I)
               ...
               DISPLAY CUADRO_SERVICIO_FILA
               DISPLAY " "
               DISPLAY "PROMEDIO DE FACTURAS DE SERVICIO"
               DISPLAY "--------------------------------------------"
               DISPLAY " "
               DISPLAY "************PROMEDIO********************"
